...
export const createDestination  = createDest
...
export const updateDestination  = updateDest
export const deleteDest         = async (id)          => api.delete(`${base}/destinations/${id}`)
export const deleteDestination  = deleteDest
...
export default {
  getStats, getPlatformStats, getUsers, updateUserRole, deleteUser,
  getDestinations, getAllDestinations, createDest, createDestination,
  updateDest, updateDestination, deleteDest, deleteDestination,
  getTrips, getAllTrips, deleteTrip,
}
